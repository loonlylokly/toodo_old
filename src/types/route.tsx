...
interface MyRouteWithLayout<T extends string | number | symbol>
  extends Layout<T> {
  type: 'layout' | 'route';
  layout: React.ReactNode | null;
  layoutPath: string;
...
interface MyRouteWithOutLayout<T extends string | number | symbol>
  extends Layout<T> {
  type: 'layout' | 'route';
  layout?: never;
  layoutPath?: never;
...
type MyLayout =
  | MyRouteWithLayout<string | number | symbol>
  | MyRouteWithOutLayout<string | number | symbol>;
